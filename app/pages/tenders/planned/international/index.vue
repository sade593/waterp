  ...
  <div>
    ...
    <div class="bg-blue-800 text-white py-16">
      <div class="container mx-auto px-6 text-center">
        <h1 class="text-4xl font-bold mb-4">დაგეგმილი ტენდერები</h1>
        <p class="text-xl opacity-90">საერთაშორისო ტენდერები</p>
      </div>
    </div>
          ...
          <main class="lg:w-2/3">
            <div class="bg-gradient-to-r from-neutral-50 to-white rounded-xl shadow-lg border border-neutral-100 p-8 mb-8">
              <div class="border-l-4 border-blue-800 pl-6 mb-6">
                <h3 class="text-2xl font-bold text-gray-800">საერთაშორისო ტენდერები</h3>
              </div>
            ...
            <div class="bg-white rounded-xl shadow-lg border border-neutral-100 sticky top-28">
              ...
              <nav class="p-6">
                <ul class="space-y-3">
                  <li>
                    <NuxtLink
                      to="/tenders/planned/international"
