  ...
  <div>
    ...
    <div class="bg-blue-800 text-white py-16">
      <div class="container mx-auto px-6 text-center">
        <h1 class="text-4xl font-bold mb-4">წყალმომარაგების კომპანიის ბიზნეს-გეგმა</h1>
    ...
    <div class="bg-white py-8">
      <div class="container mx-auto px-6">
        <div class="flex flex-col lg:flex-row gap-8 -mt-16">
          ...
          <main class="lg:w-2/3">
            <div class="bg-gradient-to-r from-neutral-50 to-white rounded-xl shadow-lg border border-neutral-100 p-8 mb-8 flex flex-col items-center text-center">
              <div class="border-l-4 border-blue-800 pl-6 mb-6 self-start">
                <h3 class="text-2xl font-bold text-gray-800">ბიზნეს-გეგმა</h3>
              </div>
              
              <div class="w-full max-w-xs mt-4">
                <img src="/water-logo.jpg" alt="Business Plan Logo" class="w-32 h-auto mx-auto mb-4 object-contain">
                <p class="text-sm text-gray-600 mb-3 leading-relaxed">
                  საქართველოს გაერთიანებული წყალმომარაგების კომპანიის ბიზნეს-გეგმა
                </p>
                <a
                  href="/business-plan.pdf"
                  target="_blank"
                  rel="noopener noreferrer"
                  class="text-sm font-medium text-white hover:bg-blue-700 px-4 py-2 rounded-lg bg-blue-800 transition-colors inline-block mt-auto"
                >
                  სრულად
                </a>
              </div>
                ...
                <ul class="space-y-3">
                  ...
                  <li>
                   ...
                   <li>
                    ...
                    >
                      <i class="fas fa-file-alt mr-3 text-blue-800"></i>
