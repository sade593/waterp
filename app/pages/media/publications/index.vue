  ...
  <div>
    ...
    <div class="bg-blue-800 text-white py-16">
      <div class="container mx-auto px-6 text-center">
        <h1 class="text-4xl font-bold mb-4">პუბლიკაციები</h1>
          ...
          <main class="lg:w-2/3">
            <div class="bg-gradient-to-r from-neutral-50 to-white rounded-xl shadow-lg border border-neutral-100 p-8 mb-8">
              <div class="border-l-4 border-blue-800 pl-6 mb-6">
                <h3 class="text-2xl font-bold text-gray-800">პუბლიკაციები</h3>
              </div>
              ...
              <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-6"> 
                ...
                >
                  ...
                  <div class="p-4">
                    ...
                    <div class="text-right mt-auto">
                      <NuxtLink :to="item.link" class="text-sm font-medium text-white hover:bg-blue-700 px-3 py-1 rounded-lg bg-blue-800 transition-colors">
                        სრულად
                      </NuxtLink>
                    </div>
                  </div>
               ...
               <div v-if="!publicationItems || publicationItems.length === 0" class="text-center text-gray-500 py-10 mt-6">
                 ინფორმაცია პუბლიკაციების შესახებ განახლდება.
               </div>
            </div>
          </main>
                ...
                <ul class="space-y-3">
                  ...
                  <li>
                    <NuxtLink
                      ...
                      class="flex items-center p-3 text-gray-700 hover:bg-gray-50 rounded-lg transition-colors"
                    >
                      <i class="fas fa-video mr-3 text-gray-500"></i>
...
const publicationItems = [
  {
    image: '/the-publications.jpg', 
    title: 'კახეთში მშვიდობაძე - 2023 წლის პრიორიტეტული დასრულებული და დაწყებული ახალი პროექტები - საახალწლო ჩართვა „მოამბეში“',
    link: '/media/publications/item-1' 
  },
];
</script>