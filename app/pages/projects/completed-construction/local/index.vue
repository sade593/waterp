<template>
  <div class="bg-gray-50 py-16">
    <div class="container mx-auto px-8">
      ...
      <h1 class="text-3xl font-bold text-gray-800 border-b pb-4 mb-10">ადგილობრივი პროექტები</h1>
          ...
          <div class="space-y-4">
            ...
            >
             ...
             <div v-if="!projects || projects.length === 0" class="text-center text-gray-500 py-10 border border-dashed border-gray-300 rounded-lg bg-white">
              ინფორმაცია დასრულებული ადგილობრივი პროექტების შესახებ განახლდება.
            </div>
...
<script setup>
import { ref } from 'vue';
import { completedLocalProjectsData } from '../../../../../data/completedLocalProjects.js';

const projects = completedLocalProjectsData;
