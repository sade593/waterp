<template>
  <div class="bg-gray-50 py-16">
    <div class="container mx-auto px-8">
      ...
      <h1 class="text-3xl font-bold text-gray-800 border-b pb-4 mb-10">დასრულებული: საერთაშორისო პროექტები</h1>
      ...
      <div class="flex flex-col md:flex-row">
          ...
          <div class="space-y-4">
            ...
            >
             ...
             <div v-if="!projects || projects.length === 0" class="text-center text-gray-500 py-10 border border-dashed border-gray-300 rounded-lg bg-white">
              ინფორმაცია დასრულებული საერთაშორისო პროექტების შესახებ განახლდება.
            </div>
        ...
        <aside class="w-full md:w-1/3 md:ml-24 mt-12 md:mt-0">
          <div class="sticky top-28">
            <ul>
              <li class="mb-5">
                <NuxtLink to="/projects/completed-construction/international" class="flex items-center text-blue-800 hover:underline">
                  <i class="fas fa-arrow-right mr-3 text-sm"></i>
                  <span>საერთაშორისო პროექტები</span>
                </NuxtLink>
              </li>
              <li class="mb-5">
                <NuxtLink to="/projects/completed-construction/local" class="flex items-center text-blue-800 hover:underline">
                  <i class="fas fa-arrow-right mr-3 text-sm"></i>
...
<script setup>
import { ref } from 'vue';
import { completedInternationalProjectsData } from '../../../../../data/completedInternationalProjects.js';

const projects = completedInternationalProjectsData;
