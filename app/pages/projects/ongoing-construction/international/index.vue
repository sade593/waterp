      ...
      <div class="flex flex-col md:flex-row">
            ...
            >
              ...
              >
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-x-6 gap-y-4">
                  ...
                  <div>
                    <strong class="block text-gray-500">შესყიდვის ტიპი:</strong>
                  ...
                  <div>
                   ...
                   <div>
                    ...
                    <span>{{ project.field1_value }}</span>
                  </div>
                </div>
              </div>
            </div>
        ...
        <aside class="w-full md:w-1/3 md:ml-24 mt-12 md:mt-0">
          <div class="sticky top-28">
            <ul>
              <li class="mb-5">
                <NuxtLink to="/projects/ongoing-construction/international" class="flex items-center text-blue-800 hover:underline">
                  <i class="fas fa-arrow-right mr-3 text-sm"></i>
                  <span>საერთაშორისო პროექტები</span>
                </NuxtLink>
              </li>
              <li class="mb-5">
                <NuxtLink to="/projects/ongoing-construction/local" class="flex items-center text-blue-800 hover:underline">
                  <i class="fas fa-arrow-right mr-3 text-sm"></i>
...
import { internationalProjectsData } from '../../../../../data/internationalProjects.js';


const projects = internationalProjectsData;
